...
async function generateTransactionExcel(transactions, filters, res) {
  ...
  // Set column widths
  worksheet.getColumn(1).width = 20; // Labels (Tracking ID)
  worksheet.getColumn(2).width = 20; // Customer Name
  worksheet.getColumn(3).width = 25; // Origin Branch
  worksheet.getColumn(4).width = 25; // Destination Branch
  worksheet.getColumn(5).width = 20; // Status
  worksheet.getColumn(6).width = 15; // Amount
  worksheet.getColumn(7).width = 12; // Weight
  worksheet.getColumn(8).width = 15; // Distance
  worksheet.getColumn(9).width = 15; // Delivery Date
  ...
  // Add Branch Name (if specific branch selected)
  ...
  // Style only the cells with data (A1 to I1) - not the entire row
