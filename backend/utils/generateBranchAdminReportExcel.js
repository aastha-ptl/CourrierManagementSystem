...
async function generateBranchAdminReportExcel(couriers, filters, res) {
  ...
  worksheet.getColumn(6).width = 25; // Destination Branch
  worksheet.getColumn(7).width = 20; // Status
  worksheet.getColumn(8).width = 12; // Weight
  worksheet.getColumn(9).width = 15; // Price
  worksheet.getColumn(10).width = 15; // Booking Date
  worksheet.getColumn(11).width = 15; // Delivery Date
...
module.exports = generateBranchAdminReportExcel;
