...
const TransactionReport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.get("http://localhost:5000/api/reports/generate-branch-admin-transaction", {
  ...
  const handleExportPDF = async () => {
    try {
      ...
      const res = await axios.get("http://localhost:5000/api/reports/export-branch-admin-transaction", {
        headers: { Authorization: `Bearer ${token}` },
        params,
        responseType: "blob",
      });
